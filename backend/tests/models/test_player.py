...
def test_assign_problem(player: Player, problem_1: Problem):
...
def test_assign_problems(player: Player, problem_1: Problem, problem_2: Problem):
    assert player.current_problem is None
...
def test_check_incorrect(player: Player, problem_1: Problem):
...
def test_check_correct(player: Player, problem_1: Problem):
    assert player.score == 0
...
def test_check_multiple(player: Player, problem_1: Problem):
    assert player.score == 0
